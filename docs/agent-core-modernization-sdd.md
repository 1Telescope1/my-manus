# MoocManus Agent 核心现代化 SDD

> 本文档只维护 MoocManus Agent 核心演进的目标设计和架构决策。任务状态、实施过程和会话交接位于 [Agent 核心现代化工作区](./agent-core-modernization/README.md)。
...
这些资料用于借鉴设计模式和开放协议，不表示 MoocManus 必须采用对应框架。
